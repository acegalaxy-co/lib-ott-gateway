...
function createTelegramClient(cfgInput = {}) {
    ...
    async function rawSendMessage({ chatId, text, extra = {}, }) {
    ...
    async function sendMessage({ chatId, text, extra = {}, meta, }) {
        if (policyPipeline) {
            const verdict = await policyPipeline.evaluate(text, { chatId, method: "sendMessage", extra, meta });
            if (!verdict.ok)
                return { ok: false, blocked: true, reason: verdict.reason, policy: verdict.policy };
            text = verdict.text;
